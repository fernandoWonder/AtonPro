...
namespace UI.Main.Views.Save
{
    public partial class FrmProducts : Form
    {
        ...
        */
        public void percentCalcReverve(decimal preco, decimal ultimoPreco)
        {
            ...
            txtPercentPrice.Text = Convert.ToInt32(percentagem) + "";
        }
        ...
        {
            decimal taxa = cmbTipoTaxa.SelectedIndex == 0 ? taxas[cmbTaxCode.SelectedIndex].Taxa : 0;

            txtPreco1Civa.Text = (decimal.Parse(txtPreco1.Text) + percentCalc(decimal.Parse(txtPreco1.Text), taxa)).ToString("F2");
            txtPreco2Civa.Text = (decimal.Parse(txtPreco2.Text) + percentCalc(decimal.Parse(txtPreco2.Text), taxa)).ToString("F2");
            txtPreco3Civa.Text = (decimal.Parse(txtPreco3.Text) + percentCalc(decimal.Parse(txtPreco3.Text), taxa)).ToString("F2");
        }

        public void calculaPrecoTaxaReverse()
        {
            decimal taxa = cmbTipoTaxa.SelectedIndex == 0 ? taxas[cmbTaxCode.SelectedIndex].Taxa : 0;

            txtPreco1.Text = (decimal.Parse(txtPreco1Civa.Text) / (1 + taxa/100)).ToString("F2");
            calculaPreco23();
            txtPreco2Civa.Text = (decimal.Parse(txtPreco2.Text) + percentCalc(decimal.Parse(txtPreco2.Text), taxa)).ToString("F2");
            txtPreco3Civa.Text = (decimal.Parse(txtPreco3.Text) + percentCalc(decimal.Parse(txtPreco3.Text), taxa)).ToString("F2");
        }
        ...
        public void calculaPreco()
        {
           // ultimoPreco = decimal.Parse(txtUltimoPreco.Text);
            txtPreco1.Text = (ultimoPreco + percentCalc(ultimoPreco, percent)).ToString("F2");
            calculaPreco23();
        }

        public void calculaPreco23()
        {
            txtPreco2.Text = (decimal.Parse(txtPreco1.Text) + percentCalc(decimal.Parse(txtPreco1.Text), int.Parse(txtPercentBetweenPrices.Text))).ToString("F2");
            txtPreco3.Text = (decimal.Parse(txtPreco2.Text) + percentCalc(decimal.Parse(txtPreco2.Text), int.Parse(txtPercentBetweenPrices.Text))).ToString("F2");
        }
        ...
        private void txtPreco1_EditValueChanged(object sender, EventArgs e)
        {
            if (txtPreco1Focus)
            {
                percentCalcReverve(decimal.Parse(txtPreco1.Text), ultimoPreco);
                calculaPreco23();
                calculaPrecoTaxa();
            }
        }
        ...
        {
            if (!txtPreco1Focus || !txtPreco1CivaFocus)
            {
                if (txtPercentPrice.Text != "-")
                {
                    percent = Convert.ToInt32(txtPercentPrice.Text);
                    calculaPreco();
                    calculaPrecoTaxa();
                }
                else
        ...
        private void txtPreco1Civa_EditValueChanged(object sender, EventArgs e)
        {
            if (!txtPreco1Focus && txtPreco1CivaFocus)
            {
                calculaPrecoTaxaReverse();
                percentCalcReverve(decimal.Parse(txtPreco1.Text), ultimoPreco);
            }
        }

        private void txtPreco1Civa_Enter(object sender, EventArgs e)
        {
            txtPreco1CivaFocus = true;
        }

        private void txtPreco1Civa_Leave(object sender, EventArgs e)
        {
            txtPreco1CivaFocus = false;
        }
        // ==============================================================================
    }
}
